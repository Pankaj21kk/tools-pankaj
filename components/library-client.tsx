              ...
              {saved.map((tool) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-full px-1.5 py-0.5 text-[10px] font-bold text-zinc-500 transition hover:bg-zinc-200 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:hover:text-zinc-100"
              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    className="rounded-full border-zinc-300 bg-white text-zinc-700 transition active:scale-[0.96] hover:border-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full border-zinc-300 bg-white text-zinc-700 transition active:scale-[0.96] hover:border-zinc-600 hover:bg-zinc-200 hover:text-zinc-900 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-700 dark:hover:text-zinc-100"
                  >
